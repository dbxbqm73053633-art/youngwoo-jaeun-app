      ...
      <div className="hero__media">
        ...
        <div className="hero__overlay">
          ...
          <h1 className="hero__title">
            세상에 단 하나뿐인 우리만의 앱<br />
            <span className="hero__titleGrad">오늘도 더 예뻐</span>
          </h1>
          <p className="hero__sub">
            함께한 날을 다정하게 세고,<br />
            추억과 마음은 탭마다 차곡차곡 모아둘게요.
          </p>

          <div className="hero__chips">
            <div className="chip">
              <div className="chip__label">우리 시작</div>
              <div className="chip__value" id="startDateLabel">—</div>
            </div>
            <div className="chip">
              <div className="chip__label">오늘</div>
              <div className="chip__value" id="todayLabel">—</div>
            </div>
          </div>
        </div>
      </div>
